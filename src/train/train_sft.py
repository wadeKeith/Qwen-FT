...
from src.train.trainer import QwenTrainer
from src.train.data import make_supervised_data_module
from src.train.params import DataArguments, ModelArguments, TrainingArguments
...
if __name__ == "__main__":
    # os.environ["WANDB_PROJECT"] = "qwen-2.5-vl"
    # os.environ["WANDB_MODE"] = "offline"
    # os.environ["WANDB_NAME"] = "7b-libero-cot"
